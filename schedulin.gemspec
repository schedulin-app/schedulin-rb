...
require_relative "lib/schedulin/version"
...
Gem::Specification.new do |spec|
  spec.name = "schedulin"
  spec.authors = ["Schedulin"]
  spec.version = Schedulin::VERSION
  spec.summary = "Ruby client library for the Schedulin API"
  spec.description = "The Schedulin Ruby library provides convenient access to the Schedulin API from Ruby."
