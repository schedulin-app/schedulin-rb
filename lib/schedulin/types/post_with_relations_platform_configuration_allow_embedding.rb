...
module Schedulin
  module Types
    class PostWithRelationsPlatformConfigurationAllowEmbedding < Internal::Types::Model
      field :caption, -> { String }, optional: true, nullable: false

      field :media, -> { Internal::Types::Array[Schedulin::Types::PostWithRelationsPlatformConfigurationAllowEmbeddingMediaItem] }, optional: true, nullable: false

      field :title, -> { String }, optional: false, nullable: false

      field :category_id, -> { String }, optional: false, nullable: false, api_name: "categoryId"

      field :visibility, -> { Schedulin::Types::PostWithRelationsPlatformConfigurationAllowEmbeddingVisibility }, optional: false, nullable: false

      field :license, -> { Schedulin::Types::PostWithRelationsPlatformConfigurationAllowEmbeddingLicense }, optional: true, nullable: false
