...
module Schedulin
  module Types
    class PostPlatformConfigurationBrandedContentSponsorIDs < Internal::Types::Model
      field :caption, -> { String }, optional: true, nullable: false

      field :media, -> { Internal::Types::Array[Schedulin::Types::PostPlatformConfigurationBrandedContentSponsorIDsMediaItem] }, optional: true, nullable: false

      field :placement, -> { Schedulin::Types::PostPlatformConfigurationBrandedContentSponsorIDsPlacement }, optional: true, nullable: false
      ...
      field :trial_reel_type, -> { Schedulin::Types::PostPlatformConfigurationBrandedContentSponsorIDsTrialReelType }, optional: true, nullable: false
