...
module Schedulin
  module Types
    class PostPlatformConfigurationAllowComment < Internal::Types::Model
      field :caption, -> { String }, optional: true, nullable: false

      field :media, -> { Internal::Types::Array[Schedulin::Types::PostPlatformConfigurationAllowCommentMediaItem] }, optional: true, nullable: false
      ...
      field :privacy_status, -> { Schedulin::Types::PostPlatformConfigurationAllowCommentPrivacyStatus }, optional: true, nullable: false
