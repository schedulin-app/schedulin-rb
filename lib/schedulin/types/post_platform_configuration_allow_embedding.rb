...
module Schedulin
  module Types
    class PostPlatformConfigurationAllowEmbedding < Internal::Types::Model
      field :caption, -> { String }, optional: true, nullable: false

      field :media, -> { Internal::Types::Array[Schedulin::Types::PostPlatformConfigurationAllowEmbeddingMediaItem] }, optional: true, nullable: false

      field :title, -> { String }, optional: false, nullable: false

      field :category_id, -> { String }, optional: false, nullable: false, api_name: "categoryId"

      field :visibility, -> { Schedulin::Types::PostPlatformConfigurationAllowEmbeddingVisibility }, optional: false, nullable: false

      field :license, -> { Schedulin::Types::PostPlatformConfigurationAllowEmbeddingLicense }, optional: true, nullable: false
