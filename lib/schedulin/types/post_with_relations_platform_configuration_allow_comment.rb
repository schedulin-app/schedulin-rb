...
module Schedulin
  module Types
    class PostWithRelationsPlatformConfigurationAllowComment < Internal::Types::Model
      field :caption, -> { String }, optional: true, nullable: false

      field :media, -> { Internal::Types::Array[Schedulin::Types::PostWithRelationsPlatformConfigurationAllowCommentMediaItem] }, optional: true, nullable: false
      ...
      field :privacy_status, -> { Schedulin::Types::PostWithRelationsPlatformConfigurationAllowCommentPrivacyStatus }, optional: true, nullable: false
