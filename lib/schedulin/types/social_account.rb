...
module Schedulin
  module Types
    class SocialAccount < Internal::Types::Model
      ...
      field :platform_data, -> { Object }, optional: true, nullable: false, api_name: "platformData"

      field :token_expires_at, -> { String }, optional: false, nullable: true, api_name: "tokenExpiresAt"

      field :user_id, -> { String }, optional: false, nullable: false, api_name: "userId"

      field :last_refresh_at, -> { String }, optional: false, nullable: true, api_name: "lastRefreshAt"
