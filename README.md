# Schedulin Ruby Library

[![fern shield](https://img.shields.io/badge/%F0%9F%8C%BF-Built%20with%20Fern-brightgreen)](https://buildwithfern.com?utm_source=github&utm_medium=github&utm_campaign=readme&utm_source=Schedulin%2FRuby)

The Schedulin Ruby library provides convenient access to the Schedulin APIs from Ruby.
...
client = Schedulin::Client.new(api_key: "<value>")
...
schedulin = Schedulin::Client.new(
    base_url: Schedulin::Environment::DEFAULT
)
```
...
rescue Schedulin::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue Schedulin::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue Schedulin::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue Schedulin::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue Schedulin::Errors::ApiError => e
