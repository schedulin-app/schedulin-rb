...
describe Schedulin::Internal::Types::Union do
  class Rectangle < Schedulin::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < Schedulin::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < Schedulin::Internal::Types::Model
