...
describe Schedulin::Internal::Types::Utils do
  Utils = Schedulin::Internal::Types::Utils

  module TestUtils
    class M < Schedulin::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < Schedulin::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < Schedulin::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = Schedulin::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { Schedulin::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "String" do
      ...
      it "raises an error if value cannot be coerced and strict" do
        assert_raises Schedulin::Internal::Errors::TypeError do
    ...
    describe "Array" do
      StringArray = Schedulin::Internal::Types::Array[String]
      ModelArray = -> { Schedulin::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { Schedulin::Internal::Types::Array[TestUtils::U] }
