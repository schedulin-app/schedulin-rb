...
describe Schedulin::Internal::Types::Model do
  ...
  class ExampleModel < Schedulin::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < Schedulin::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < Schedulin::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < Schedulin::Internal::Types::Model
